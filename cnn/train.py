...
# nohup python -u train.py --batch_size 96 --epochs 600 --auxiliary --cutout --seed 1 --arch 'darts_gbctrain' --save '20cells_96bs_600eps_1seed_darts_gbctrain_arch' > trainevalseed1.log 2>&1 &
...
parser.add_argument('--model_path', type=str, default='./experiment_cache', help='path to save the model')
